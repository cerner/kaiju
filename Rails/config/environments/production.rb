Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "kaiju_#{Rails.env}"
  ...
  config.x.node_server_url = ENV['KAIJU_NODE_SERVER_URL'] || 'http://localhost:8080'

  config.x.use_node_server = false
end
