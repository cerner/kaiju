...
class RenameMenuItem extends React.Component {
  constructor(props) {
    super(props);
...
RenameMenuItem.propTypes = propTypes;
...
export default connect(mapStateToProps, mapDispatchToProps)(RenameMenuItem);
